-- The live stream tables of dhan: dhan.ticks, dhan.order_updates.
--
-- Written by the persisters in bin/dhan/ - persist_ticks from dhan:quotes:stream, persist_orders from
-- dhan:order-updates:stream -
...
CREATE TABLE IF NOT EXISTS dhan.ticks (
...
CREATE TABLE IF NOT EXISTS dhan.order_updates (
    time                timestamptz   not null,
