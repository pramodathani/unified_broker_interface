-- The live stream tables of zerodha: zerodha.ticks, zerodha.order_updates.
--
-- Written by the persisters in bin/zerodha/ - persist_ticks from zerodha:quotes:stream, persist_orders from
-- zerodha:order-updates:stream -
...
CREATE TABLE IF NOT EXISTS zerodha.ticks (
...
CREATE TABLE IF NOT EXISTS zerodha.order_updates (
    time                timestamptz   not null,
