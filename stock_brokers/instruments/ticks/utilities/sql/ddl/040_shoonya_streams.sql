-- The live stream tables of shoonya: shoonya.ticks, shoonya.order_updates.
--
-- Written by the persisters in bin/shoonya/ - persist_ticks from shoonya:quotes:stream, persist_orders from
-- shoonya:order-updates:stream -
...
CREATE TABLE IF NOT EXISTS shoonya.ticks (
...
CREATE TABLE IF NOT EXISTS shoonya.order_updates (
    time                timestamptz   not null,
