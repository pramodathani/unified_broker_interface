-- The live stream tables of flattrade: flattrade.ticks, flattrade.order_updates.
--
-- Written by the persisters in bin/flattrade/ - persist_ticks from flattrade:quotes:stream, persist_orders from
-- flattrade:order-updates:stream -
...
CREATE TABLE IF NOT EXISTS flattrade.ticks (
...
CREATE TABLE IF NOT EXISTS flattrade.order_updates (
    time                timestamptz   not null,
