...
class StoxkartTickNormalizer(TickNormalizer):
    """Normalizes the ticks `bin/stoxkart/instruments/websocket_quotes` writes from Stoxkart's broadcast websocket."""
