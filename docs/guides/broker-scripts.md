...
Zerodha's are there already; the other brokers' scripts still carry their sockets inside them until each is
moved. Either way the script writes three keys:
